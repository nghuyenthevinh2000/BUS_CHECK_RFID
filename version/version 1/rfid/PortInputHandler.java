      ...
      while(output==null){
         comPort.addDataListener(new SerialPortDataListener() {
            ...
            public void serialEvent(SerialPortEvent event) {
               ...
               int readByte = comPort.readBytes(newData, newData.length);
               output = newData;
               logger.log(Level.INFO, String.format("Bytes read = %s | Bytes failed to read = %s", availableByte, availableByte - readByte));
            }
         });
      }
      closePort();
